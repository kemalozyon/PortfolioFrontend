...
const Navbar = () => {
  ...
  const ThemeToggle = ({ className = '' }) => (
    <button
      ...
      className={`w-9 h-9 flex items-center justify-center rounded-full bg-gray-100 dark:bg-slate-800 hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors ${className}`}
    >
      {isDark ? (
